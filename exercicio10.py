...
def main():
    ...
    bot.browse(r"C:\Users\lrand\OneDrive\Área de Trabalho\antonio\exercicio10\formulariocadastro.html")  
    bot_cadastro = BotCadastro()
    processar_bot(bot_cadastro, bot)  
    bot.wait(3000)  

    bot.browse(r"C:\Users\lrand\OneDrive\Área de Trabalho\antonio\exercicio10\formularioatualizacao.html")
